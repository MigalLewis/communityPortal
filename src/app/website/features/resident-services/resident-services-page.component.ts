...
@Component({ selector: 'app-resident-services-page', standalone: true, imports: [CommonModule, ReactiveFormsModule, RouterLink, FileUploadComponent], templateUrl: './resident-services-page.component.html', styleUrl: './resident-services-page.component.scss', changeDetection: ChangeDetectionStrategy.OnPush })
export class ResidentServicesPageComponent implements OnInit {
  ...
  protected chooseFiles(files: File[]) { this.error.set(''); this.attachments = files; }
