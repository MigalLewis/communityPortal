...
describe('validateCommunityProject', () => {
  const valid: any = { slug: 'pocket-park', title: 'Pocket Park', summary: 'Summary', content: 'Full content', category: 'Environment', status: 'active', image: { url: 'park.jpg', altText: 'A park' }, progress: 65, featured: true, startDate: '2026-01-01', completionDate: '2026-06-01' };
